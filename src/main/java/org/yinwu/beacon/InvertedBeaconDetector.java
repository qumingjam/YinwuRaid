...
public class InvertedBeaconDetector {
    ...
    private void loadLayersFromConfig() {
        try {
            ...
            for (java.util.Map.Entry<Integer, ConfigManager.LayerConfig> entry : beaconConfig.getLayers().entrySet()) {
    ...
    private void useDefaultDetectionConfig() {
        ...
        this.containerTypes.add(Material.TRAPPED_CHEST);
    ...
    public int getBeaconLevel(Location beaconLocation) {
        ...
        if (level >= 4 && checkEasterEggBeacon(beaconLocation)) {
